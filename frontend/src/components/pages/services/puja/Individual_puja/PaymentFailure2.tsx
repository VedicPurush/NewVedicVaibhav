...
const PujaPaymentFailure: React.FC = () => {
  const router = useRouter();

  const handleGoBack = () => router.push("/services/puja");
    ...
    >
      ...
      >
        ...
        <Typography variant="body1" sx={{ mt: 1.2, color: "text.secondary" }}>
          Oh no! Your <strong>puja</strong> payment didn’t go through.
          <br />
...
export default PujaPaymentFailure;
