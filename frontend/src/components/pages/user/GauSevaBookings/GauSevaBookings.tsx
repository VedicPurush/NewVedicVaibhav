        ...
        {bookings.map((booking) => {
          ...
          return (
            <Col key={booking._id} xs={24} sm={24} md={24} lg={24} xl={24}>
              <div className="bg-white rounded-2xl p-5 md:p-7 shadow-[0_4px_20px_-4px_rgba(249,115,22,0.1)] border border-orange-100/50 hover:shadow-[0_8px_30px_-4px_rgba(249,115,22,0.15)] transition-all duration-300 relative overflow-hidden group">
                {/* Top accent */}
                  ...
                  <div className="flex flex-wrap gap-2">
                    <span
                      className={`px-3 py-1 rounded-full text-xs font-bold border shadow-sm tracking-wide uppercase ${
                        STATUS_COLORS[booking.paymentStatus] ||
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 gap-x-6 gap-y-4">
                  <div>
                    <span className="text-xs text-orange-500 font-semibold uppercase tracking-wider block mb-0.5">
                      Devotee Name
                    </span>
                  ...
                  {booking.gotra && (
                    <div>
                      <span className="text-xs text-gray-500 font-semibold uppercase tracking-wider block mb-0.5">
                        Gotra
                      </span>
                ...
                {booking.specialMessage && (
                  <div className="mt-4 bg-orange-50/60 border border-orange-100 rounded-xl px-4 py-3">
